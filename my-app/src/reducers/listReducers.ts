...
import {loadMoviesSuccessAction, addMovieSuccessAction,updateMovieAction,DeleteMovieAction } from '../actions/listActions';


export default function listReducer(
  state = initialState.movies,
  action:loadMoviesSuccessAction|addMovieSuccessAction|updateMovieAction|DeleteMovieAction
   ) {
  switch (action.type) {
